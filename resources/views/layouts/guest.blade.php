...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>ShopEase - {{ request()->is('register') ? 'Daftar' : 'Login' }}</title>
        ...
        <div class="min-h-screen flex">
            ...
            <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden" style="background: linear-gradient(135deg, rgba(12, 85, 135, 0.95) 0%, rgba(8, 132, 209, 0.95) 100%);">
                ...
                <div class="absolute inset-0 z-0">
                    <img src="{{ asset('images/auth-bg.webp') }}" alt="ShopEase Background" class="w-full h-full object-cover opacity-50">
                </div>
