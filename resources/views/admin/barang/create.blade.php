    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            <div class="flex items-center space-x-3 mb-2">
                ...
                <h2 class="text-2xl font-bold text-gray-900">Tambah Barang Baru</h2>
            </div>
            <p class="text-sm text-gray-600">Isi informasi produk yang akan ditambahkan</p>
        </div>
            ...
            <div class="p-6">
                <form method="POST" action="{{ route('admin.barang.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4 p-4 rounded-lg bg-gray-50 border border-gray-200">
                        ...
                        <!-- Margin Preview -->
                        <div id="marginPreview" class="mt-3 p-3 rounded-lg border hidden" style="border-color: #C7E339; background: #fffef0;">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="file" name="gambar" accept="image/*"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#0C5587] focus:border-transparent">
                        <p class="text-xs text-gray-500 mt-1">Format: JPG, PNG, GIF (Max 2MB) - Opsional</p>
                    </div>
