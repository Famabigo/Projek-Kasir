    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            <div class="flex items-center space-x-3 mb-2">
                <a href="{{ route('admin.barang.index') }}" class="text-gray-600 hover:text-gray-800 transition-colors">
            ...
            <div class="p-6">
                <form method="POST" action="{{ route('admin.barang.update',$barang) }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4 text-center">
                        ...
                        <img src="{{ Storage::url($barang->gambar) }}" alt="{{ $barang->nama_barang }}" class="h-32 w-32 object-cover rounded-lg border border-gray-300 mx-auto">
                    </div>
                    @endif
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="ukuran" value="{{ $barang->ukuran }}"
                                class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#0C5587] focus:border-transparent"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="harga_beli" value="{{ $barang->harga_beli }}" step="0.01" required
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <span class="absolute left-3 top-2.5 text-gray-500 text-sm">Rp</span>
                                    <input type="number" name="harga_jual" value="{{ $barang->harga_jual }}" step="0.01" required
                                        class="w-full pl-10 pr-3 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#0C5587] focus:border-transparent"
                                        placeholder="0"
                                        oninput="hitungMargin()">
                                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <input type="date" name="expired_at" value="{{ $barang->expired_at ? $barang->expired_at->format('Y-m-d') : '' }}"
                                class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#0C5587] focus:border-transparent">
