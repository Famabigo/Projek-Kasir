...
<div class="py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between mb-8">
            ...
            <a href="<?php echo e(route('kasir.members.index')); ?>" class="text-gray-600 hover:text-gray-800 px-4 py-2 rounded-lg font-medium transition-all duration-200 flex items-center space-x-2 border-2 border-gray-300 hover:border-gray-400">
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <!-- Card Body -->
            <form method="POST" action="<?php echo e(route('kasir.members.store')); ?>" class="p-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="tel" id="no_hp" name="no_hp" value="<?php echo e(old('no_hp')); ?>" required
                                class="pl-10 w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-200 outline-none"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <textarea id="alamat" name="alamat" rows="4" required
                                ...
                                placeholder="Jl. Contoh No. 123, RT/RW 01/02, Kelurahan, Kecamatan, Kota, Kode Pos"><?php echo e(old('alamat')); ?></textarea>
                        </div>
                ...
                <div class="flex items-center justify-end space-x-4 mt-8 pt-6 border-t border-gray-200">
                    <a href="<?php echo e(route('kasir.members.index')); ?>" class="px-6 py-3 border-2 border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-50 transition-all duration-200">
                        Batal
                    </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kasir\resources\views/kasir/members/create.blade.php ENDPATH**/ ?>