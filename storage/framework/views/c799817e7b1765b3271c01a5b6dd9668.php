  ...
  <?php if(auth()->guard()->check()): ?>
    <?php if(auth()->user()->role === 'admin'): ?>
      ...
      <a href="<?php echo e(route('admin.notifikasi.index')); ?>" class="flex items-center justify-between px-4 py-3 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('admin.notifikasi.*') ? 'text-white shadow-lg' : 'text-gray-700 hover:text-white'); ?>" style="<?php echo e(request()->routeIs('admin.notifikasi.*') ? 'background: linear-gradient(135deg, #0C5587 0%, #0884D1 100%);' : ''); ?>" onmouseover="if(!this.classList.contains('shadow-lg')) this.style.background='linear-gradient(135deg, #B1D7F2 30%, #0884D1 100%)'" onmouseout="if(!this.classList.contains('shadow-lg')) this.style.background=''">
        ...
        ?>
        <?php if($notifCount > 0): ?>
          <span class="px-2 py-1 text-xs font-bold text-white rounded-full" style="background: #C7E339; color: #0C5587;"><?php echo e($notifCount); ?></span>
        <?php endif; ?>
      </a>
      <a href="<?php echo e(route('admin.member-approval.index')); ?>" class="flex items-center justify-between px-4 py-3 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('admin.member-approval.*') ? 'text-white shadow-lg' : 'text-gray-700 hover:text-white'); ?>" style="<?php echo e(request()->routeIs('admin.member-approval.*') ? 'background: linear-gradient(135deg, #0C5587 0%, #0884D1 100%);' : ''); ?>" onmouseover="if(!this.classList.contains('shadow-lg')) this.style.background='linear-gradient(135deg, #B1D7F2 30%, #0884D1 100%)'" onmouseout="if(!this.classList.contains('shadow-lg')) this.style.background=''">
        <div class="flex items-center space-x-3">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        ?>
        <?php if($memberPendingCount > 0): ?>
          <span class="px-2 py-1 text-xs font-bold text-white rounded-full" style="background: #C7E339; color: #0C5587;"><?php echo e($memberPendingCount); ?></span>
        <?php endif; ?>
      </a>
    <?php elseif(auth()->user()->role === 'kasir'): ?>
      <a href="<?php echo e(route('kasir.dashboard')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('kasir.dashboard') ? 'text-white shadow-lg' : 'text-gray-700 hover:text-white'); ?>" style="<?php echo e(request()->routeIs('kasir.dashboard') ? 'background: linear-gradient(135deg, #0C5587 0%, #0884D1 100%);' : ''); ?>" onmouseover="if(!this.classList.contains('shadow-lg')) this.style.background='linear-gradient(135deg, #B1D7F2 30%, #0884D1 100%)'" onmouseout="if(!this.classList.contains('shadow-lg')) this.style.background=''">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
        </svg>
        <span class="font-medium">Dashboard</span>
      </a>
      <a href="<?php echo e(route('kasir.transaksi.index')); ?>" class="flex items-center justify-between px-4 py-3 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('kasir.transaksi.*') ? 'text-white shadow-lg' : 'text-gray-700 hover:text-white'); ?>" style="<?php echo e(request()->routeIs('kasir.transaksi.*') ? 'background: linear-gradient(135deg, #0C5587 0%, #0884D1 100%);' : ''); ?>" onmouseover="if(!this.classList.contains('shadow-lg')) this.style.background='linear-gradient(135deg, #B1D7F2 30%, #0884D1 100%)'" onmouseout="if(!this.classList.contains('shadow-lg')) this.style.background=''">
        <div class="flex items-center space-x-3">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        ?>
        <?php if($pesananMenungguCount > 0): ?>
          <span class="px-2 py-1 text-xs font-bold text-white rounded-full" style="background: #C7E339; color: #0C5587;"><?php echo e($pesananMenungguCount); ?></span>
        <?php endif; ?>
      </a>
      <a href="<?php echo e(route('kasir.stok.index')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('kasir.stok.*') ? 'text-white shadow-lg' : 'text-gray-700 hover:text-white'); ?>" style="<?php echo e(request()->routeIs('kasir.stok.*') ? 'background: linear-gradient(135deg, #0C5587 0%, #0884D1 100%);' : ''); ?>" onmouseover="if(!this.classList.contains('shadow-lg')) this.style.background='linear-gradient(135deg, #B1D7F2 30%, #0884D1 100%)'" onmouseout="if(!this.classList.contains('shadow-lg')) this.style.background=''">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
        </svg>
        <span class="font-medium">Lihat Stok</span>
      </a>
      <a href="<?php echo e(route('kasir.members.index')); ?>" class="flex items-center justify-between px-4 py-3 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('kasir.members.*') || request()->routeIs('kasir.member-approval.*') ? 'text-white shadow-lg' : 'text-gray-700 hover:text-white'); ?>" style="<?php echo e(request()->routeIs('kasir.members.*') || request()->routeIs('kasir.member-approval.*') ? 'background: linear-gradient(135deg, #0C5587 0%, #0884D1 100%);' : ''); ?>" onmouseover="if(!this.classList.contains('shadow-lg')) this.style.background='linear-gradient(135deg, #B1D7F2 30%, #0884D1 100%)'" onmouseout="if(!this.classList.contains('shadow-lg')) this.style.background=''">
        <div class="flex items-center space-x-3">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH C:\laragon\www\kasir\resources\views/components/sidebar.blade.php ENDPATH**/ ?>