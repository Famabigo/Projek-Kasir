...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title>Market - <?php echo e(request()->is('register') ? 'Daftar' : 'Login'); ?></title>
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                <a href="<?php echo e(route('pembeli.dashboard')); ?>" class="block px-3 py-2 rounded-lg hover:bg-gray-100 transition-colors">
                                ...
                                <a href="<?php echo e(route('pembeli.cart')); ?>" class="block px-3 py-2 rounded-lg hover:bg-gray-100 transition-colors">
                                    <div class="flex items-center space-x-3">
                                        <svg class="w-5 h-5" style="color: #0C5587;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                <a href="<?php echo e(route('kasir.dashboard')); ?>" class="block px-3 py-2 rounded-lg hover:bg-gray-100 transition-colors">
                                    <div class="flex items-center space-x-3">
                                        <svg class="w-5 h-5" style="color: #0C5587;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="<?php echo e(route('kasir.transaksi.index')); ?>" class="block px-3 py-2 rounded-lg hover:bg-gray-100 transition-colors">
                                    <div class="flex items-center space-x-3">
                                        <svg class="w-5 h-5" style="color: #0C5587;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                <a href="<?php echo e(route('admin.dashboard')); ?>" class="block px-3 py-2 rounded-lg hover:bg-gray-100 transition-colors">
                                    <div class="flex items-center space-x-3">
                                        <svg class="w-5 h-5" style="color: #0C5587;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="<?php echo e(route('admin.barang.index')); ?>" class="block px-3 py-2 rounded-lg hover:bg-gray-100 transition-colors">
                                    <div class="flex items-center space-x-3">
                                        <svg class="w-5 h-5" style="color: #0C5587;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="min-h-screen flex pt-16">
            ...
            <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden" style="background: linear-gradient(135deg, rgba(12, 85, 135, 0.95) 0%, rgba(8, 132, 209, 0.95) 100%);">
                ...
                <div class="absolute inset-0 z-0">
                    <img src="<?php echo e(asset('images/auth-bg.webp')); ?>" alt="Market Background" class="w-full h-full object-cover opacity-50">
                </div>
