    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="card-hover bg-white rounded-xl shadow-lg border border-gray-100 p-6 mb-6">
            <form method="GET" action="<?php echo e(route('admin.laporan.index')); ?>">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                    ...
                    <div class="flex items-end">
                        <a href="<?php echo e(route('admin.laporan.pdf', ['tanggal_mulai' => $tanggalMulai, 'tanggal_akhir' => $tanggalAkhir])); ?>" class="w-full bg-red-500 hover:bg-red-600 text-white px-6 py-2 rounded-lg font-medium transition-all duration-200 flex items-center justify-center space-x-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex items-end">
                        <a href="<?php echo e(route('admin.laporan.excel', ['tanggal_mulai' => $tanggalMulai, 'tanggal_akhir' => $tanggalAkhir])); ?>" class="w-full bg-green-500 hover:bg-green-600 text-white px-6 py-2 rounded-lg font-medium transition-all duration-200 flex items-center justify-center space-x-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                            </svg>
                            <span>Excel</span>
        ...
        <div class="card-hover bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                ...
                <table class="min-w-full">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-blue-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-700"><?php echo e($t->created_at->format('d M Y H:i')); ?></td>
                            <td class="px-6 py-4 text-sm text-gray-700"><?php echo e($t->kasir->name ?? '-'); ?></td>
                            <td class="px-6 py-4 text-sm">
                                <?php if($t->member): ?>
                                <span class="px-2 py-1 rounded text-xs font-medium text-white" style="background: linear-gradient(135deg, #0C5587 0%, #0884D1 100%);"><?php echo e($t->member->nama_member); ?></span>
                                <?php else: ?>
                            ...
                            <td class="px-6 py-4 text-sm text-gray-700">Rp <?php echo e(number_format($t->diskon, 0, ',', '.')); ?></td>
                            <td class="px-6 py-4">
                                <span class="font-semibold" style="color: #0C5587;">Rp <?php echo e(number_format($t->keuntungan, 0, ',', '.')); ?></span>
                            </td>
                            <td class="px-6 py-4 text-center">
                                <a href="<?php echo e(route('admin.laporan.detail', $t->id)); ?>" class="text-blue-600 hover:text-blue-800 font-medium text-sm flex items-center justify-center space-x-1">
            ...
            <div class="px-6 py-4 border-t border-gray-200 bg-gray-50">
                <?php echo e($transaksi->appends(['tanggal_mulai' => $tanggalMulai, 'tanggal_akhir' => $tanggalAkhir])->links()); ?>
