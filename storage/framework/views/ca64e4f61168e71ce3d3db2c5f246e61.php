                ...
                <form method="post" action="<?php echo e(route('profile.destroy')); ?>">
                    ...
                    <div class="mb-6">
                        ...
                        <input id="password" name="password" type="password" 
                            ...
                            required
                            class="w-full px-4 py-3 rounded-lg border-2 focus:outline-none focus:ring-2 focus:ring-red-500 <?php $__errorArgs = ['password', 'userDeletion'];
...
<?php /**PATH C:\laragon\www\kasir\resources\views/profile/partials/delete-user-form.blade.php ENDPATH**/ ?>