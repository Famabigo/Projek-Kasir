    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center space-x-4">
                ...
                <?php if(auth()->user()->role === 'pembeli'): ?>
                <!-- Cart Icon -->
                <a href="<?php echo e(route('pembeli.cart')); ?>" class="relative p-2 hover:bg-gray-100 rounded-lg">
                    ...
                    ?>
                    <?php if($cartCount > 0): ?>
                    <span class="absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center"><?php echo e($cartCount); ?></span>
                    <?php endif; ?>
                </a>
                <?php endif; ?>
...
<?php endif; ?>
    ...
    <div x-show="menuOpen"
        ...
        <div class="px-6 py-8 max-w-7xl mx-auto">
            <div class="flex justify-center gap-8">
                <a href="<?php echo e(route('pembeli.dashboard')); ?>" class="flex items-center space-x-2 text-gray-700 hover:text-[#0C5587] pb-2 <?php echo e(request()->routeIs('pembeli.dashboard') ? 'border-b-2 border-[#0C5587] text-[#0C5587]' : ''); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                    </svg>
                    <span>Dashboard</span>
                </a>
                <a href="<?php echo e(route('pembeli.cart')); ?>" class="flex items-center space-x-2 text-gray-700 hover:text-[#0C5587] pb-2 <?php echo e(request()->routeIs('pembeli.cart') ? 'border-b-2 border-[#0C5587] text-[#0C5587]' : ''); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"/>
                    </svg>
                    <span>Keranjang</span>
                </a>
                <a href="<?php echo e(route('pembeli.pesanan.index')); ?>" class="flex items-center space-x-2 text-gray-700 hover:text-[#0C5587] pb-2 <?php echo e(request()->routeIs('pembeli.pesanan.*') ? 'border-b-2 border-[#0C5587] text-[#0C5587]' : ''); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>
                    </svg>
                    <span>Pesanan</span>
                </a>
                <a href="<?php echo e(route('pembeli.member-request.index')); ?>" class="flex items-center space-x-2 text-gray-700 hover:text-[#0C5587] pb-2 <?php echo e(request()->routeIs('pembeli.member-request.*') ? 'border-b-2 border-[#0C5587] text-[#0C5587]' : ''); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="px-6 py-8 max-w-7xl mx-auto">
            <div class="flex justify-center gap-8">
                ...
                <a href="<?php echo e(route('kasir.transaksi.create')); ?>" class="flex items-center space-x-2 text-gray-700 hover:text-[#0C5587] pb-2 <?php echo e(request()->routeIs('kasir.transaksi.create') ? 'border-b-2 border-[#0C5587] text-[#0C5587]' : ''); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                    </svg>
                    <span>Buat Transaksi</span>
                </a>
                <a href="<?php echo e(route('kasir.transaksi.index')); ?>" class="flex items-center space-x-2 text-gray-700 hover:text-[#0C5587] pb-2 <?php echo e(request()->routeIs('kasir.transaksi.index') || request()->routeIs('kasir.transaksi.show') ? 'border-b-2 border-[#0C5587] text-[#0C5587]' : ''); ?>">
                    <div class="relative">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>
                        </svg>
                        ...
                        ?>
                        <?php if($pesananMenunggu > 0): ?>
                        <span class="absolute -top-1 -right-1 bg-red-500 text-white text-[10px] font-bold rounded-full w-4 h-4 flex items-center justify-center animate-pulse"><?php echo e($pesananMenunggu); ?></span>
                        <?php endif; ?>
                    </div>
                    <span>Transaksi</span>
                </a>
                <a href="<?php echo e(route('kasir.laporan.index')); ?>" class="flex items-center space-x-2 text-gray-700 hover:text-[#0C5587] pb-2 <?php echo e(request()->routeIs('kasir.laporan.*') ? 'border-b-2 border-[#0C5587] text-[#0C5587]' : ''); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="px-6 py-8 max-w-7xl mx-auto">
            <div class="flex justify-center gap-8">
                ...
                <a href="<?php echo e(route('admin.barang.index')); ?>" class="flex items-center space-x-2 text-gray-700 hover:text-[#0C5587] pb-2 <?php echo e(request()->routeIs('admin.barang.*') ? 'border-b-2 border-[#0C5587] text-[#0C5587]' : ''); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
                    </svg>
                    <span>Barang</span>
                ...
                <a href="<?php echo e(route('admin.member-approval.index')); ?>" class="flex items-center space-x-2 text-gray-700 hover:text-[#0C5587] pb-2 <?php echo e(request()->routeIs('admin.member-approval.*') ? 'border-b-2 border-[#0C5587] text-[#0C5587]' : ''); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 9a2 2 0 10-4 0v5a2 2 0 01-2 2h6m-6-4h4m8 0a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
                    <span>Member</span>
                </a>
                <a href="<?php echo e(route('admin.laporan.index')); ?>" class="flex items-center space-x-2 text-gray-700 hover:text-[#0C5587] pb-2 <?php echo e(request()->routeIs('admin.laporan.*') ? 'border-b-2 border-[#0C5587] text-[#0C5587]' : ''); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden md:hidden border-t">
        <div class="px-4 py-3 space-y-1">
            <?php if(auth()->guard()->check()): ?>
            <a href="<?php echo e(route('dashboard')); ?>" class="block px-3 py-2 rounded text-gray-700 hover:bg-gray-100">Dashboard</a>
            <a href="<?php echo e(route('profile.edit')); ?>" class="block px-3 py-2 rounded text-gray-700 hover:bg-gray-100">Profile</a>
            <form method="POST" action="<?php echo e(route('logout')); ?>">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\kasir\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>