...
<?php endif; ?>
        ...
        <div class="flex items-center justify-between">
            ...
            <?php if(Route::has('password.request')): ?>
                <div class="text-sm">
                    <a href="<?php echo e(route('password.request')); ?>" class="font-medium hover:underline" style="color: #0884D1;">
                        Lupa password?
                    </a>
                </div>
            <?php endif; ?>
        ...
        <div class="text-center">
            <p class="text-sm text-gray-600">
                Belum punya akun?
                <a href="<?php echo e(route('register')); ?>" class="font-semibold hover:underline ml-1" style="color: #0884D1;">
                    Daftar sekarang
                </a>
            </p>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\kasir\resources\views/auth/login.blade.php ENDPATH**/ ?>