...
<div class="py-8" style="background-color: #EDF7FC; min-height: 100vh;">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            ...
            <p class="text-gray-600 text-sm mt-1">Selamat datang kembali, <?php echo e(auth()->user()->name); ?></p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <?php if($barangStokMinim->count() > 0): ?>
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <h3 class="font-bold text-gray-900 mb-2 flex items-center">
                            Stok Menipis 
                            <span class="ml-2 bg-yellow-100 text-yellow-800 text-xs font-semibold px-2.5 py-0.5 rounded-full"><?php echo e($barangStokMinim->count()); ?></span>
                        </h3>
                        <div class="space-y-2">
                            <?php $__currentLoopData = $barangStokMinim->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $barang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex justify-between items-center py-2 border-b border-gray-100 last:border-0">
                                <span class="text-sm text-gray-700"><?php echo e($barang->nama_barang); ?></span>
                                <span class="text-sm font-semibold text-yellow-600">Stok: <?php echo e($barang->stok); ?></span>
                            </div>
            ...
            <?php if($barangAkanExpired->count() > 0): ?>
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <h3 class="font-bold text-gray-900 mb-2 flex items-center">
                            Akan Expired 
                            <span class="ml-2 bg-red-100 text-red-800 text-xs font-semibold px-2.5 py-0.5 rounded-full"><?php echo e($barangAkanExpired->count()); ?></span>
                        </h3>
                        <div class="space-y-2">
                            <?php $__currentLoopData = $barangAkanExpired->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $barang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex justify-between items-center py-2 border-b border-gray-100 last:border-0">
                                <span class="text-sm text-gray-700"><?php echo e($barang->nama_barang); ?></span>
                                <span class="text-sm font-semibold text-red-600"><?php echo e($barang->expired_at ? $barang->expired_at->format('d M Y') : '-'); ?></span>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                ...
                <table class="min-w-full">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-4 py-3">
                                <span class="font-semibold" style="color: #0C5587;">#<?php echo e($t->id); ?></span>
                            </td>
                            <td class="px-4 py-3 text-sm text-gray-700"><?php echo e($t->created_at->format('d M Y H:i')); ?></td>
                            <td class="px-4 py-3 text-sm text-gray-700"><?php echo e($t->kasir->name ?? '-'); ?></td>
                            <td class="px-4 py-3">
                                <span class="font-semibold text-green-600">Rp <?php echo e(number_format($t->total_harga, 0, ',', '.')); ?></span>
                            </td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kasir\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>