...
<div class="py-8" style="background-color: #EDF7FC; min-height: 100vh;">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 text-sm mt-1">Selamat datang, <?php echo e(auth()->user()->name); ?></p>
    </div>

    <!-- Quick Actions -->
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <a href="<?php echo e(route('kasir.transaksi.create')); ?>" class="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md hover-lift">
        ...
        <a href="<?php echo e(route('kasir.transaksi.index')); ?>" class="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md hover-lift">
            <div class="flex items-center space-x-4">
                <div class="flex-shrink-0 w-12 h-12 rounded-lg flex items-center justify-center" style="background-color: #EDF7FC;">
                    <svg class="w-6 h-6" style="color: #0C5587;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="<?php echo e(route('kasir.stok.index')); ?>" class="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md hover-lift">
            <div class="flex items-center space-x-4">
                <div class="flex-shrink-0 w-12 h-12 rounded-lg flex items-center justify-center" style="background-color: #EDF7FC;">
                    <svg class="w-6 h-6" style="color: #0C5587;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="<?php echo e(route('kasir.members.index')); ?>" class="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md hover-lift">
            <div class="flex items-center space-x-4">
                <div class="flex-shrink-0 w-12 h-12 rounded-lg flex items-center justify-center" style="background-color: #EDF7FC;">
                    <svg class="w-6 h-6" style="color: #0C5587;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kasir\resources\views/kasir/dashboard.blade.php ENDPATH**/ ?>